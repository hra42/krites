...
Use the [Bug Report](https://github.com/hra42/krites/issues/new?template=bug_report.md) issue template. Include:
...
Use the [Feature Request](https://github.com/hra42/krites/issues/new?template=feature_request.md) issue template. Describe:
